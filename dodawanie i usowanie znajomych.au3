...
Local $romWyk 		 	= 0 
Local $Willich  		= 0         
Local $Xander25  		= 0          	;Willich1
Local $Jabra  			= 0         	;Willich2
Local $XanderS 		 	= 0         	;Willich3
Local $LindseyK  		= 0          	;Willich4
Local $Kalczek  		= 0         	;Willich5
Local $2goLor    		= 0         
Local $dydzej  			= 0        	;2goLor1
Local $elemeczka  		= 0      	;2goLor2
Local $bladra  			= 0        	;2goLor3
Local $entertejment   	= 0         	;2goLor4
Local $Schramm  		= 0       	;2goLor5
Local $czersi   		= 0         
Local $Skyllip 			= 0      	;czersi1
Local $Kersten  	 	= 0         	;czersi2
Local $kollesnik  		= 0       	;czersi3
Local $sekerto 			= 0       	;czersi4
Local $globowski  		= 0          	;czersi5
Local $Quellbrum  	  	= 0         
Local $gAlaKlok 	 	= 0          	;Quellbrum1
...
$wylogujSieNapis='MouseClick("left",1279,569,1))' ; napis "wyloguj sie" na stronie logowania
